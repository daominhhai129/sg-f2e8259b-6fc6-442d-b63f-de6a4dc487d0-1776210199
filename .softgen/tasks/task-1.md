...
Set up the main admin dashboard layout on the home page so we have a clear structure for managing users and their digital business cards. Focus on a left sidebar, top header, and main content with summary metrics and a users table using mock data.
